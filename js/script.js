...
function crystalButton() {
  ...
  if (((inputedMonth == "February") && (inputedDay == "30" || inputedDay == "31")) || ((inputedMonth == "April") && (inputedDay == "31")) || ((inputedMonth == "June") && (inputedDay == "31")) || ((inputedMonth == "September") && (inputedDay == "31")) || ((inputedMonth == "November") && (inputedDay == "31"))) {
    ...
    document.getElementById("image").innerHTML = '<img src="./images/birthstones/garnet.jpg" alt="Garnet" width="34%" height="34%" />'
    ...
    document.getElementById("image").innerHTML = '<img src="./images/birthstones/amythest.jpg" alt="Amethyst" width="25%" height="25%" />'
    ...
    document.getElementById("image").innerHTML = '<img src="./images/birthstones/diamond.jpg" alt="Diamond" width="40%" height="40%" />'
    ...
    document.getElementById("image").innerHTML = '<img src="./images/birthstones/pearls.jpg" alt="Pearl" width="27%" height="27%" />'
    ...
    document.getElementById("image").innerHTML = '<img src="./images/birthstones/topaz.png" alt="Topaze" width="25%" height="23%" />'
...
function zodiacButton() {
  ...
  if (((inputedMonth == "February") && (inputedDay == "30" || inputedDay == "31")) || ((inputedMonth == "April") && (inputedDay == "31")) || ((inputedMonth == "June") && (inputedDay == "31")) || ((inputedMonth == "September") && (inputedDay == "31")) || ((inputedMonth == "November") && (inputedDay == "31"))) {
    ...
    document.getElementById("zodiacInfo4").innerHTML =
      "Ruling Planet: Mars"
    document.getElementById("image").innerHTML = '<img src="./images/zodiacs/aries.png" alt="aries" width="15%" height="15%" />'
    ...
    document.getElementById("image").innerHTML = '<img src="./images/zodiacs/sagittarius.webp" alt="sagittarius" width="15%" height="15%" />'
